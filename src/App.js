			...
			<main>
				...
				<Switch>
					<Route
						...
						path="/"
						render={(props) => (
							<FrontPage logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/global"
						render={(props) => (
							<Global logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/account"
						render={(props) => (
							<Account logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/backpack"
						render={(props) => (
							<Backpack logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/coordinates"
						render={(props) => (
							<Coordinates logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/apod"
						render={(props) => (
							<Apod logger={this.logger} state={this.state} {...props} />
						)}
					/>
					<Route
						exact
						path="/notes"
						render={(props) => (
							<Notes logger={this.logger} state={this.state} {...props} />
						)}
					/>
