    ...
    populateCoordinates=() => {
        this.coordinate=this.state.coordinates.map((coordinate,key) =>
                ...
                <Heading>Coordinates #{coordinate._id.slice(-1)}</Heading>
                    <InfoWrapper>
                    <Info style={{position: "relative", display: "inline-block", marginLeft: "3vh"}}>LAT={coordinate.lat}</Info>
                    <Info style={{position: "relative",display: "inline-block",marginLeft: "3vh"}}>LONG={coordinate.lon}</Info>
                        <div>
    ...
    render() {
        ...
        return (<Anchor>
            ...
            <Editor style={{background: "#21212cc2"}}>
                ...
                <br/>
                <Info>LATITUDE</Info>
                <New type="text" value={this.state.value} name="lat" onChange={this.handleChange}></New>
                <Info style={{marginLeft:"33vh"}}>LONGITUDE</Info>
                <New type="text" value={this.state.value} name="lon" onChange={this.handleChange}></New>
